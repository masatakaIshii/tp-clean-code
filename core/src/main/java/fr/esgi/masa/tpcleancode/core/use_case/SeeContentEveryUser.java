...
public class SeeContentEveryUser implements SeeContent {
    ...
    private final PersistentBooksStorage persistentBooksStorage;
    private final Logger logger;

    public SeeContentEveryUser(PersistentBooksStorage persistentBooksStorage, Logger logger) {
        this.persistentBooksStorage = persistentBooksStorage;
        this.logger = logger;
    }
    ...
    public void execute() {
        try {
            var listBooks = persistentBooksStorage.getAll();
